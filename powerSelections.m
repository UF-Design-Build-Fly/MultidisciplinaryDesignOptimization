...
%            hours, estimated system weight (pounds).
    ...
    plane.power.amps = table(row,:).current/2; %Hacked for single tractor
    plane.power.watts = table(row,:).watts/2; %Hacked for single tractor
    plane.power.time = table(row,:).time*2; %Hacked for single tractor
    plane.power.thrust = table(row,:).thrust/2; %Hacked for single tractor
