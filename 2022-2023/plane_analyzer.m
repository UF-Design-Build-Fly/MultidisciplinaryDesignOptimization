...
Electronic_Package_Weight = [0,3:.5:5]; %Electronic Package Weight for mission 2 in pounds
...
winners = plane(I);
save("winners_full_loop.mat", "winners"); %save top 100 airplanes. It is impractical to save all airplanes checked.
