function [plane] = empennage(plane, HSAR, VSAR)
    ...
    plane.empennage.HSarea = HS_area;
    plane.empennage.HSchord = HS_chord;
    plane.empennage.HSweight = HS_weight;
    plane.empennage.HScd = HS_Cd;
    plane.empennage.VSarea = VS_area;
    plane.empennage.VSchord = VS_chord;
    plane.empennage.VSweight = VS_weight;
    plane.empennage.VScd = VS_Cd;
end