...
Electronic_Package_Weight = [0,2:.5:8]; %Electronic Package Weight for mission 2 in pounds

Antenna_Length = 1;%0:5:40; %Antenna length, inches
...
winners = plane(I);
save("winners_m2.mat", "winners"); %save top 100 airplanes. It is impractical to save all airplanes checked.
